#!/usr/bin/env python3
"""
Smooth 3D keypoint trajectories from fabric evaluation results.
...
Usage:
    python smooth_fabric_keypoints.py --input_dir fabric_evaluation_results/cloth_no_occlusion_front_3sec/chunk_2/clip_00
    python smooth_fabric_keypoints.py --input_dir fabric_evaluation_results/cloth_no_occlusion_front_3sec/chunk_2/clip_00 --sigma 3.0
"""
...
def main():
    parser = argparse.ArgumentParser(description='Smooth fabric 3D keypoint trajectories')
    ...
    print("=" * 60)
    print("SMOOTH FABRIC 3D KEYPOINTS")
    print("=" * 60)
    ...
    print(f"  edge_connections shape: {edge_connections.shape}")
